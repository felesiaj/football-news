...
from main.views import show_main, create_news, show_news, show_xml, show_json, show_json_by_id, show_xml_by_id
from main.views import register, login_user, logout_user, delete_news, edit_news, add_news_entry_ajax, proxy_image, create_news_flutter
